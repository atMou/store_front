...
const DateRangePicker: React.FC<DateRangePickerProps> = ({
  ...
  const handleYearChange = (selectedYear: string | string[] | null) => {
    if (selectedYear !== null && typeof selectedYear === "string") {
      setCurrentMonth(
  ...
  const handleMonthSelect = (selectedMonth: string | string[] | null) => {
    if (selectedMonth !== null && typeof selectedMonth === "string") {
